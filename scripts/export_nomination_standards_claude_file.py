...
def build_markdown() -> str:
    ...
    metrics = [
        ...
        ("음주·위험·무면허", lambda r: any(cat in r["categories"] for cat in GROUPS["음주·위험·무면허"])),
...
1. 국민의힘은 체납 전반, 돈·신뢰 범죄, 음주·위험·무면허, 조세, 성범죄·마약 소수 사례에서 더 관대한 공천으로 보인다.
2. 민주당은 무투표 당선 규모, 공무집행방해·업무방해, 보조금, 현 초고액 체납 일부, 병역 미필에서 약점이 보인다.
3. 조국혁신당은 후보 수는 적지만 공직 검증 전과율과 음주·위험·무면허 비율이 높게 나온다.
