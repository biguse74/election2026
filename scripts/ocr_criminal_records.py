...
CRIME_KEYWORDS = {
    ...
    "보험·금융": ["보험업법", "이자제한법", "부정수표단속법", "대부업", "자동차손해배상보장법", "전자금융거래법", "여신전문금융업법"],
    "폭력": ["폭력행위", "공동폭행", "폭행", "상해"],
    "공무집행방해": ["공무집행방해"],
    "업무방해": ["업무방해"],
    "재물손괴": ["재물손괴"],
    ...
    "입찰방해": ["입찰방해"],
    "도로교통": ["도로교통법", "드로교통법", "도로교통댑", "도로법", "일반교통방해"],
    "자동차관리": ["자동차관리법"],
    "환경": [
        "폐기물관리법",
        "대기환경보전법",
    ...
    "노동": ["근로기준법", "고용보험법", "산업안전보건법", "근로자퇴직급여보장법"],
    "농수산": [
        "농수산물의원산지표시",
        "원산지표시",
        "농산물품질관리법",
    ...
    "도박": ["도박"],
    "국가보안법": ["국가보안법", "국보법"],
    "집시법": ["집회및시위", "집회 및 시위", "집회및", "집회 및", "시위에관한법률", "시위에 관한 법률"],
    "국가공무원법": ["국가공무원법"],
