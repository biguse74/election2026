...
def main():
    ...
    summary = {
        ...
        "limitations": [
            ...
            "사전투표·당일투표 패턴 변화 미반영",
            "MBC 여론조사는 226개 시군구 단위로 제공되지 않아 prior로 사용 안 됨 (시도지사·재보궐은 반영)",
        ],
    }
...
<div class="intro"><strong>시도지사·재보궐과 달리 이 페이지는 여론조사를 prior로 반영하지 않습니다 — 과거 6회차 개표 패턴만 사용.</strong> 시군구는 후보 개별 효과·현직 이점·지역 토호 영향이 훨씬 커서 모델 정확도가 떨어지고, MBC 베이지안 추정치도 226개 시군구 단위로는 제공되지 않습니다. 환경별 의석 분포 예측에는 시도지사·재보궐 결과를 더 신뢰하는 게 안전합니다.</div>
{blocks}
<section>
