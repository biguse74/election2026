...
<div class="pills">
  <div class="pill p-d"><span class="pl">민주</span><b>{modes['D']}곳</b><span class="ps">예상범위 {cis['D'][0]}~{cis['D'][1]}</span></div>
  <div class="pill p-c"><span class="pl">국힘</span><b>{modes['C']}곳</b><span class="ps">예상범위 {cis['C'][0]}~{cis['C'][1]}</span></div>
